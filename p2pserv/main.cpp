...
#define MSG_PORT_LOCAL     9971
#define FTP_PORT_LOCAL     9981
...
int WINAPI WinMain(HINSTANCE hT, HINSTANCE hP, LPSTR szCmdLine, int iShow)
{
    ...
    CWorkLogic::GetInstance()->StartWork(MSG_PORT_LOCAL, FTP_PORT_LOCAL);
    char szInfo[128] = {0};
    wnsprintfA(szInfo, 128, "%d", MSG_PORT_LOCAL);
